...
template <> constexpr inline auto CustomCalendar::qt_create_metaobjectdata<qt_meta_tag_ZN14CustomCalendarE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<CustomCalendar, qt_meta_tag_ZN14CustomCalendarE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject CustomCalendar::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14CustomCalendarE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14CustomCalendarE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN14CustomCalendarE_t>.metaTypes,
    nullptr
} };
...
void *CustomCalendar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14CustomCalendarE_t>.strings))
